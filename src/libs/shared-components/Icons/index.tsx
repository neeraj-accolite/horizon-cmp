export { default as UserAvatar } from './IconList/UserAvatar';
export { default as UpArrow } from './IconList/UpArrow';
export { default as Star } from './IconList/Star';
export { default as LocalOffer } from './IconList/LocalOffer';
